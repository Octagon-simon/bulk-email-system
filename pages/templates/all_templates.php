                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button data-tempId="<?php print($s['id']); ?>"
                                ...
                                data-file="<?php print('uploads/templates/' . $s['temp_file']); ?>" type="button"
                                class="btn btn-info btn-view-temp">View</button>
                        </td>
                        <td class="text-center">
                            <form method="post"
                                onsubmit="return confirm('Are you sure you want to delete this template?')">
                                <input type="hidden" name="action" value="del_temp">
                                <input type="hidden" name="template" value="<?php print($s['id']); ?>">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            Array.from($('.btn-view-temp')).forEach(e => {
                $(e).on('click', () => {
                    ...
                    document.getElementById('temp_upd').href = 'update_template.php?template=' + e.dataset['tempid']
